...
<link rel="stylesheet" href="<?php echo BASE; ?>assets/css/jquery.countdown.css">
    <link href="<?php echo BASE; ?>assets/css/ninja-slider.css" rel="stylesheet" />
    <link href="<?php echo BASE; ?>assets/css/thumbnail-slider.css" rel="stylesheet" type="text/css" />
...
<div class="listingpageview">
    ...
    <div class="search-pannel">
        <div class="container">
            <div class="col-md-11 col-md-offset-1 col-centered">
...
<div class="col-md-12">
<h1 class="pagetitle"><?php echo $product->title; ?> (#<?php echo $product->product_id; ?>)</h1>
</div>
        ...
        <div id="ninja-slider" style="float:left;">
            ...
            <ul>
                <?php foreach ($product_imgs as $img){
                    if($img != '') {
                    ?>
                    <li><a class="ns-img" href="<?php echo BASE; ?>uploads/products/<?php echo $product->product_id; ?>/<?php echo $img->product_img; ?>"></a></li>
                
            <?php
          }else{?>
             
                    <li><a class="ns-img" href="<?php echo BASE; ?>assets/images/view-slider.png"></a></li>
            ...
            <div class="inner">
                <ul>
                  <?php foreach ($product_imgs as $img){
                    if($img != '') {
                    ?>
                    <li><a class="thumb" href="<?php echo BASE; ?>uploads/products/<?php echo $product->product_id; ?>/<?php echo $img->product_img; ?>"></a></li>
            <?php
          }else{?>
                    <li><a class="thumb" href="<?php echo BASE; ?>assets/images/view-slider.png"></a></li>
...
<script src="<?php echo BASE; ?>assets/js/ninja-slider.js" type="text/javascript"></script>

<script src="<?php echo BASE; ?>assets/js/thumbnail-slider.js" type="text/javascript"></script>
