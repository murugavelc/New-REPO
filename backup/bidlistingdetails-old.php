...
<div class="preload"><div></div></div>
 <!-- MAIN CONTENT -->
  ...
  <div class="">
      <?php $i = 0; foreach ($product_imgs as $img){
          if($img != '') {
              ?>
              <div class="lof-main-item">
                  <img src="<?php echo BASE; ?>uploads/products/<?php echo $product->product_id; ?>/<?php echo $img->product_img; ?>" class="img-responsive">
              </div>
              <?php
          }else{?>
              <div class="lof-main-item">
                  <img src="<?php echo BASE; ?>assets/images/view-slider.png" class="img-responsive">
              </div>
          <?php }
          $i++;
      } ?>
  ...
  <div class="lof-navigator-outer">
        <ul class="lof-navigator">
            <?php $i = 0; foreach ($product_imgs as $img){
                if($img != '') {
                    ?>
                    <li><div><img class="img-responsive" src="<?php echo BASE; ?>uploads/products/<?php echo $product->product_id; ?>/thumb/<?php echo $img->product_img; ?>"></div></li>

                    <?php
                }else{?>
                    <li><div><img src="<?php echo BASE; ?>assets/images/view-sliders.png" class="img-responsive"></div></li>
                <?php }
                $i++; } ?>
