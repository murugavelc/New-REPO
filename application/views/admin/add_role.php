...
<!--                <h4><i class="icon-user-plus position-left"></i> <span class="text-semibold">User Roles</span> - Add New Role</h4>-->
<!--            </div>-->
<!---->
        ...
        <form id="addRoleForm" action="#" novalidate>
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <legend class="text-semibold"><i class="icon-user-plus position-left"></i> Add New Role</legend>
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Role Name" required name="type_name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <br>
                                        <div class="checkbox">
                                            <label><input type="checkbox" id="check_all" class="control-primary" checked="checked">Select All / Deselect All</label>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <tbody>
                                    <?php foreach($APPMODULES as $module_id => $module){ ?>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="control-primary" name="module_<?php echo $module_id; ?>_add" checked="checked"></td>
                                            <td><input type="checkbox" class="control-primary" name="module_<?php echo $module_id; ?>_view" checked="checked"></td>
                                            <td><input type="checkbox" class="control-primary" name="module_<?php echo $module_id; ?>_edit" checked="checked"></td>
                                            <td><input type="checkbox" class="control-primary" name="module_<?php echo $module_id; ?>_delete" checked="checked"></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
