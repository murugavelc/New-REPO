                                            ...
                                            <tr>
                                                <td align='left'>
                                                    ...
                                                    <p style="font-family:Tahoma, Geneva, sans-serif;; font-size:13px; color:#333">
                                                        ...
                                                        <b><?php echo $product->title.' (#'.$product->product_id.')'; ?></b> has been awaiting approval. Please approve the product to close.<br><br>


                                                        <a href="<?php echo ADMIN_URL; ?>" style="background: #0080c3; border-radius: 3px;  color: #fff; display: inherit; margin: 10px 0;padding: 5px 8px; text-decoration: none;  text-align: center;" target="_blank">Click to Approve</a>
                                                    </p>
