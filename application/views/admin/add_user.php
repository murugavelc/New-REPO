    ...
    <div class="page-header page-header-xs">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-user-plus position-left"></i> <span class="text-semibold">Users</span> - Add New <?php echo $title; ?></h4>
            </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo ADMIN_URL.$redirect; ?>"> Users - <?php echo $title; ?></a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Employee Number" name="employee_number" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        <input type="hidden" name="role" value="<?php echo $this->uri->segment(4) ?>">
                                </div>
...
$(document).ready(function () {
    $('#AddUser').submit(function(e){
        ...
        $.ajax({
            url: "<?php echo ADMIN_URL; ?>users/insert",
            type: 'POST',
            dataType: 'json',
            data: formData,
            processData: false,
