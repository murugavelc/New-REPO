                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" id="motor" name="motor_non" value="1" class="styled motor_non" checked="checked">
                                                Motor
                                            </label>

                                            <label class="radio-inline">
                                                <input type="radio" id="non_motor" name="motor_non" value="0" class="styled motor_non">
                                                Non-Motor
                                            </label>
                                        </div>
