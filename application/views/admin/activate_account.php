...
<head>
    ...
    <title>Salvage::Admin - Activate Account</title>
                ...
                <form id="activate_account" action="">
                    <div class="panel panel-body login-form">
                        <div class="text-center">
                            ...
                            <h5 class="content-group">Activate your account <small class="display-block">Enter your credentials below</small></h5>
                        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#activate_account').submit(function(e){
            ...
            $.ajax({
                url: base_url+'users/activate_action',
                type: 'POST',
                data: form,
                dataType: 'json',
