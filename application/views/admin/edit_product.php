                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" id="motor" name="motor_non" value="1" class="styled motor_non" <?php echo ($product->is_motor == 1?'checked="checked"':''); ?>>
                                                Motor
                                            </label>

                                            <label class="radio-inline">
                                                <input type="radio" id="non_motor" name="motor_non" value="0" class="styled motor_non" <?php echo ($product->is_motor == 0?'checked="checked"':''); ?>>
                                                Non-Motor
                                            </label>
                                        </div>

                                        <fieldset id="vehicleDetails" class="content-group">
...
<!--                                                        <input type="text" placeholder="Year" name="year" class="form-control" value="--><?php //echo $product->year; ?><!--">-->
                                        ...
                                        <div class="row">
                                            <div id="OwnerDetails" class="col-sm-6">
                                                <fieldset class="content-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="Base Price" name="base_price" value="<?php echo $product->base_price; ?>" class="form-control numeric">
                                                            </div>
                                                        </div>
                                                    </div>
...
$(document).ready(function () {
    ...
    $(document).on('click','.motor_non',function(e){
        if($('#motor:checked').length == 0){
//            alert('false');
            $('#vehicleDetails').hide();
            $('#OwnerDetails').hide();
        }else{
