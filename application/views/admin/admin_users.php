    ...
    <div class="page-header page-header-xs">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-user-plus position-left"></i> <span class="text-semibold"> Salvage Admins</span></h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo ADMIN_URL; ?>users/add/2" class="btn btn-success"><i class="icon-user-plus"></i> Add New Salvage Admin</a>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Users - Salvage Admins</li>
            </ul>
