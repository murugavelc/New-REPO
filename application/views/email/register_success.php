                                ...
                                <td class='movableContentContainer ' valign='top'>
                                    ...
                                    <div class='movableContent'>
                                        <table width="570" border="0" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td align='center'>
                                                    <h2 style="font-family:Tahoma, Geneva, sans-serif; font-size:24px; margin: 13px 0 0; text-align: center;">Welcome Salvage User</h2>
                                            ...
                                            <tr>
                                                <td align='left'>
                                                    ...
                                                    <p style="font-family:Tahoma, Geneva, sans-serif;; font-size:13px; color:#333">
                                                        ...
                                                        Welcome to GGCIC. Thankyou for registering in our site. Kindly do wait for our reply as we are undergoing some verification process..
                                                        <br />
														<br>
                                                        Thankyou
                                                        <br /><br>
