                                ...
                                <td class='movableContentContainer ' valign='top'>
                                    ...
                                    <div class='movableContent'>
                                        <table width="570" border="0" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td align='center'>
                                                    <h2 style="font-family:Tahoma, Geneva, sans-serif; font-size:24px; margin: 13px 0 0; text-align: center;">Forget Password</h2>
                                            ...
                                            <tr>
                                                <td align='left'>
                                                    ...
                                                    <p style="font-family:Tahoma, Geneva, sans-serif;; font-size:13px; color:#333">
                                                        ...
                                                        We have received your request for forgot password.
                                                        <br />
														<br>
                                                        your Tempory password is <b>"<?php echo $password;?>"</b>.<br /><br>
														Please use this password to access your account temporary and do kindly change your password after signing up. 
                                                        <br /><br>
														Note: This password is valid untill you change your password.
														<br /><br />
                                                        <a href="<?php echo BASE; ?>" style="background: #0080c3; border-radius: 3px;  color: #fff; display: inherit; margin: 10px 0;padding: 5px 8px; text-decoration: none;  text-align: center;" target="_blank">Click to here to login</a>
                                                    </p>
