                                            ...
                                            <tr>
                                                <td align='left'>
                                                    ...
                                                    <p style="font-family:Tahoma, Geneva, sans-serif;; font-size:13px; color:#333">
                                                        ...
                                                        Kindly For your Notification:,<br><br>
                                                        Title : <?php echo $product->title; ?><br>
                                                        Product Id : <?php echo $product->product_id; ?>
                                                        <br /><br />
														<br>
                                                        For this Respective <?php echo $product->title; ?>, has bidded  for the sum of <b><?php echo $bid; ?> DH</b> . 
                                                        If you want to ReBid for the same product again please click Here
                                                        <br /><br />

                                                        <a href="<?php echo BASE; ?>" style="background: #0080c3; border-radius: 3px;  color: #fff; display: inherit; margin: 10px 0;padding: 5px 8px; text-decoration: none;  text-align: center;" target="_blank">Click to start bidding</a>
                                                    </p>
