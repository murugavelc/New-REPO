                                            ...
                                            <tr>
                                                <td align='left'>
                                                    ...
                                                    <p style="font-family:Tahoma, Geneva, sans-serif;; font-size:13px; color:#333">
                                                        ...
                                                        Welcome to salvage user panel.Click the below link to reset your password.
                                                        <br /><br />
                                                        <a href="<?php echo SALVAGE_URL.'login/reset/'.$reset_key; ?>" style="background: #0080c3; border-radius: 3px;  color: #fff; display: inherit; margin: 10px 0;padding: 5px 8px; text-decoration: none;  text-align: center;" target="_blank">Click to reset your password</a>
                                                    </p>
