                                            ...
                                            <tr>
                                                <td align='left'>
                                                    ...
                                                    <p style="font-family:Tahoma, Geneva, sans-serif;; font-size:13px; color:#333">
                                                        ...
                                                        You have been added as <?php GLOBAL $USER_ROLES; echo $USER_ROLES[$user['role']]; ?> to salvage user panel to manage. Please click activate button to create your password and activate your account.<br /><br />

                                                        <a href="<?php echo SALVAGE_URL; ?>users/activate/<?php echo $reset_key; ?>" style="background: #0080c3; border-radius: 3px;  color: #fff; display: inherit; margin: 10px 0;padding: 5px 8px; text-decoration: none;  text-align: center;" target="_blank">Activate your Account</a>
                                                    </p>
