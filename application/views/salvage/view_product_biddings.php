        ...
        <div class="page-header-content">
            ...
            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo SALVAGE_URL; ?>products/view/<?php echo $product->product_id; ?>" class="btn btn-success"><i class="icon-circle-left2"></i><span> Back to Product</span></a>
                </div>
            </div>
        </div>
                ...
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h1 class="no-margin display-inline-block"><small>Current Bid: </small><br><?php echo $current_bid['current_price']; ?><small> dh</small></h1>
                            ...
                            <?php if(!empty($all_bids)){ $i = 1;
                                foreach ($all_bids as $bid){ ?>
                                    <tr>
                                        ...
                                        <td><?php echo $bid->bid_price; ?><small> dh</small></td>
                    ...
                    <div class="panel-footer text-center" style="padding:15px">
                        ...
                        <?php if(!empty($winner)){
                            ...
                            echo '<h4>Close Price :'.$winner->bid_price.'<small> dh</small></h4>';
                        }else{
                        ...
                        <?php if(date('Y-m-d H:i:s',strtotime($product->end_datetime)) < date('Y-m-d H:i:s',strtotime('now')) ){
                            if($product->bid_winner == 0){
                                if(!empty($winner)){
                                    ?>
                                    <h4 class="label label-info" style="padding: 10px 15px; font-size: 15px;">Awaiting Closing</h4>
<!--                                    <form id="CloseBidForm" action="">-->
<!--                                        <input type="hidden" name="product_id" value="--><?php //echo $product->product_id; ?><!--">-->
<!--                                        <input type="hidden" name="winner_id" value="--><?php //echo $winner->user_id; ?><!--">-->
<!--                                        <input type="hidden" name="bid_price" value="--><?php //echo $winner->bid_price; ?><!--">-->
<!--                                        <button type="submit" class="btn bg-danger" href="--><?php //echo SALVAGE_URL; ?><!--products/close/--><?php //echo $product->product_id; ?><!--">Close Bidding</button>-->
<!--                                    </form>-->
                                <?php }else{ ?>
                    ...
                    <div class="panel-body">
                        <div id="ProfileView" class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <h1 class="no-margin"><?php echo $product->base_price; ?><small> dh</small></h1>
                            </div>
                        ...
                        <div class="text-center">
                            <a class="btn bg-blue-300" href="<?php echo SALVAGE_URL; ?>products/view/<?php echo $product->product_id; ?>"><i class="icon-eye"></i> View Product</a>
                        </div>
                    </div>
                </div>
