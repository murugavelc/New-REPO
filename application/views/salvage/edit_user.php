    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-user-plus position-left"></i> <span class="text-semibold">Profile</span> - <?php echo ucfirst($user->first_name.' '.$user->last_name); ?></h4>
            </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Profile - <?php echo ucfirst($user->first_name.' '.$user->last_name); ?></li>
...
$(document).ready(function () {
    $('#AddUser').submit(function(e){
        ...
        $.ajax({
            url: "<?php echo SALVAGE_URL; ?>users/update",
            type: 'POST',
            dataType: 'json',
            data: formData,
            processData: false,
            ...
            success: function(data){
                ...
                if(data.error){
                    ...
                    swal({
                        ...
                        window.location.href = '<?php echo SALVAGE_URL; ?>profile';
                    });
                }
            },
            error: function(){
