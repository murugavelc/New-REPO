    ...
    <div class="page-header page-header-xs">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-user-plus position-left"></i> <span class="text-semibold"> Admin Users</span></h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="<?php echo ADMIN_URL; ?>users/add/1" class="btn btn-success"><i class="icon-user-plus"></i> Add New Admin</a>
                </div>
            </div>
        </div>
