            ...
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="<?php echo SALVAGE_URL; ?>products" class="btn btn-success"><i class="icon-circle-left2"></i><span> Back to Products</span></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="text-center">
                                <?php if($product->bid_winner == 0){ ?>
                                    <a class="btn bg-blue-300" href="<?php echo SALVAGE_URL; ?>products/edit/<?php echo $product->product_id; ?>"><i class="icon-pencil"></i> Edit Product</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <h1 class="no-margin"><small>Current Bid: </small><br><?php echo $current_bid['current_price']; ?><small> dh</small></h1>
                                </div>
                        ...
                        <div class="panel-footer text-center" style="padding:15px">
                            <a class="btn bg-success" href="<?php echo SALVAGE_URL; ?>products/view_biddings/<?php echo $product->product_id; ?>"><i class="icon-eye"></i> View Biddings</a>
                        </div>
                    </div>
