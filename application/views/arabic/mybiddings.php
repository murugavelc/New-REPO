...
<li class="active"><a href="<?php echo BASE; ?>myaccount/mybiddings">المزادات التي شاركت فيها</a></li>
...
<h2 class="title">المزادات التي شاركت فيها</h2>
