    ...
    <div class="search-pannel">
        <div class="container">
            <div class="col-md-8 col-md-offset-1 col-centered">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <input type="text" class="form-control" placeholder="بحث" id="autosearch" name="autosearch" value="<?php echo $_POST['autosearch']; ?>"/>
    ...
    <div class="container">
        <div class="row">
           ...
           <div class="col-md-8">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="lising-head">
                                        ...
                                        <div class="col-md-4 stat-bidding-btn">
                                            <div class="row">
                                                <a href="<?php echo BASE; ?>biddings/view/<?php echo $product->product_id; ?>" class="start-bid">بداية المزاد</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bidding-footer">
                                        ...
                                        <div class="col-md-3 col-xs-6 left-bor">
                                          <h6>عرض </h6>
                                            <p class="date">تاريخ  بدء  المزاد</p>
            ...
            <label class="formlabel">نوع الوقود</label><br>
            <ul class="frontend">
            <li><input type="checkbox" value="1" name="fuel-diesel" id="check1" <?php echo ($_POST['fuel-diesel'] ==1)?"checked":""; ?>><label for="check1">ديزل</label></li>
            <li><input type="checkbox" value="2" name="fuel-petrol" id="check2" <?php echo ($_POST['fuel-petrol'] ==2)?"checked":""; ?>><label for="check2">بنزين</label></li>
            <li><input type="checkbox" value="3" name="fuel-gas" id="check3" <?php echo ($_POST['fuel-gas'] == 3)?"checked":""; ?>><label for="check3" >الغازولين</label></li>
            </ul>
            </div>
