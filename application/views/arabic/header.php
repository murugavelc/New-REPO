...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo BASE; ?>assets/css/salvage-arabic.css">
</head>
<body>
                            ...
                            <div class="top-contact">
                                ...
                                <li>
                                          <div class="btn-group language">
                                              <a class="dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-sort-desc" aria-hidden="true"></i>العربية</a>
                                              <div class="dropdown-menu">
                                                <a href="javascript:void(0)" onclick="languagechange('0');">English</a>
                                            </div>
                                   </li>
                                 <li class="lest"><i class="fa fa-fw fa-envelope"></i> examplemail@gmail.com</li>
                                 <li class="end"><i class="fa fa-fw fa-phone"></i> 8002499988</li>
                                </ul>
                                <div class="sing-det">
                               <?php if(isset($_SESSION['sv_user_logged']) && $_SESSION['sv_user_logged'] != ''){ ?>
                                            ...
                                            <div class="btn-group">
                                              ...
                                              <div class="dropdown-menu">
                                                <a href="<?php echo BASE; ?>myaccount"">حسابي</a>
                                                <a href="<?php echo BASE; ?>myaccount/forgetpassword">تغيير كلمة السر</a>
                                                <a href="<?php echo BASE; ?>login/logout">خروج</a>
                                            </div>
                                       
                                    <?php }else{ ?>
                                        <a href="<?php echo BASE; ?>">تسجيل الدخول</a>
                                    <?php } ?>
                    ...
                    <div class="navbar-collapse collapse menu">
                        <div class="row">
                            ...
                            <ul class="nav navbar-nav">
                                <!--<li><a href="<?php echo BASE; ?>" class="<?php echo ($pmenu == '' || $pmenu == 'home' ? 'active':''); ?>">الصفحة الرئيسية</a></li>-->
                                <li><a href="<?php echo BASE; ?>biddings" class="<?php echo (($pmenu == 'biddings' && $pmenu1 == '')  ? 'active':''); ?>">المزادات</a></li>
								<li><a href="<?php echo BASE; ?>biddings/motor" class="<?php echo ($pmenu1 == 'motor' ? 'active':''); ?>">المركبات</a></li>
                                <li><a href="<?php echo BASE; ?>biddings/non_motor" class="<?php echo ($pmenu1 == 'non_motor' ? 'active':''); ?>">غير المركبات</a></li>
                            </ul>
							<?php } else { ?>
						    <ul class="nav navbar-nav">
                                <li class="withoutmenu">يرجى التسجيل أو الدخول لبدء المزايدة</li>
							</ul>
                        <?php } ?> 	
                        </div> </div>
