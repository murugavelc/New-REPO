...
<li class="active"><a href="<?php echo BASE; ?>myaccount">معلومات الحساب</a></li>
<li><a href="<?php echo BASE; ?>myaccount/mybiddings">المزادات التي شاركت فيها</a></li>
<li><a href="<?php echo BASE; ?>myaccount/mywatchlist">مشاهداتي</a></li>
<li><a href="<?php echo BASE; ?>myaccount/forgetpassword">تغيير كلمة المرور</a></li>
</ul>
</div></div>
...
<div class="tab-pane active" id="accountinfo">
                    ...
                    <div class="row">
                         ...
                         <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="email" id="email" class="form-control" tabindex="5" readonly="true" type="text" value="<?php echo $value['email'];?>">
                                </div>
                            </div>
                       ...
                       <div class="col-xs-12 col-md-6">
                        ...
                        <div class="col-xs-12 col-md-6">
                          <div class="form-group">
                           <div class="col-md-12"><div class="row"><label>تاريخ الولادة</label></div></div>
                           <div class="row">
							<div class="col-xs-4">
                            <?php 
                                    $dob=$value['dob'];
                         ...
                         <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="additional_no" id="additional_no" class="form-control" tabindex="17" type="text" value="<?php echo $value['additional_number'];?>">
                                </div>
                            </div>
                             <div class="col-xs-12 col-md-6"  tabindex="18">
                            <div class="form-group">
                                <label>الهوية الوطنية</label>
                                <input name="national_id" id="national_id"  class="form-control"  value="<?php echo $value['national_id']?>" type="text">
                             </div>
                          </div>
                        </div>
                          <div class="row">
                         <div class="col-xs-12 col-md-12 text-center" tabindex="19">
