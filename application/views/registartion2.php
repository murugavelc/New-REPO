        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 register">
                    ...
                    <h2 class="title mart-25">Register</h2>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-6">
                                  <div class="form-group"  tabindex="18">
                                    ...
                                    Browse <input name="file_attach" id="file_attach" type="file">
                                    </span>
                            ...
                            <div class="form-group frontend  mart-25" tabindex="19">
                                <input name="condition_check" id="condition_check" value="false" for="condition_check"   type="checkbox"><label for="condition_check" class="check-label">Terms and Conditions</label>
                                  <div id="conditon_error" style="color: red; font-size:12px;">Terms and Conditions is required</div>
                           </div>
                          </div>
...
<script>
    ...
    $('#RegisterForm').submit(function(e){
            ...
            if(mobile.val().trim() == '')
            {
                ...
                mobile.after('<div class="c_error">Mobile Number is required</div>');
                error = true;
            }
            if(file.val() == ''){
            ...
            if(building_number.val().trim()=='')
            {
                ...
                building_number.after('<div class="c_error">Building Number is required</div>');
                error = true;
