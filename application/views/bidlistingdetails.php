                        ...
                        <div class="col-md-8">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="col-md-7 text-left"><p><?php echo $product->km_driven; ?> <?php if($product->km_driven != '') { ?>km<?php } ?></p></div>
                                </li>

                                <li>
                                    <div class="col-md-5 head">Fuel</div>
                                    <div class="col-md-7 text-left"><p><?php if($product->fuel != 0) { echo $FUEL[$product->fuel]; } ?></p></div>
                                </li>

                                <li>
                                    <div class="col-md-5 head">Seating capacity</div>
                                    <div class="col-md-7 text-left"><p><?php if($product->seating_capacity != 0) { echo $product->seating_capacity; } ?></p></div>
                                </li>

                                <li>
                                    <div class="col-md-5 head">Transmission Type</div>
                                    <div class="col-md-7 text-left"><p><?php echo $TRNSMISSION[$product->transmission_type]; ?></p></div>
                                </li>
